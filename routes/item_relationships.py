...
def get_item_relationship(child_id: str, relationship_type: str = "parent_of", db: Session = Depends(get_db)):
...
def delete_item_relationship(child_id: str, relationship_type: str = "parent_of", db: Session = Depends(get_db)):
